...
p <- p + geom_point(
  ...
  alpha = 0.03, size = 0.7, color = "#f4f4f4")
# North line
p <- p + geom_segment(
  data = seg_north,
...
# p <- p + coord_equal()
p <- p + theme(
  text = element_text(family = "alegreya", colour = "#f4f4f4"),
  ...
  plot.background = element_rect(fill = "#183778", colour = "#183778"),
  plot.margin = margin(20,20,20,20, unit = "pt"))

# Export to PNG
ggsave(
  here::here("img/20220105.png"),
  last_plot(), height = 6, width = 4, dpi = 600,
