...
# Export to file
ggsave(
  here::here("img/offcuts/20220106_offcut07.png"),
  last_plot(), width = 8, height = 8, units = "cm",
  device = "png", type = "cairo")
...
dat <- scrawl_build(
  seed = seed_num, n_paths = 1000, n_steps = 200, sz_step = 2, sz_slip = 4)
...
# Export to file
ggsave(
  here::here("img/offcuts/20220106_offcut08.png"),
  last_plot(), width = 8, height = 8, units = "cm",
  device = "png", type = "cairo")
...
dat <- scrawl_build(
  seed = seed_num, n_paths = 1000, n_steps = 600, sz_step = 2, sz_slip = 4)
